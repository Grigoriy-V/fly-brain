...
![Рис. 2](../docs/figures/layers_activity.gif)

*Рис. 2. Как выглядят уровни: активность восьми типов клеток на решётке из 721
...
![Рис. 3](../docs/figures/decoding_by_type.gif)

*Рис. 3. Линейное чтение модели ноль: ridge-декодер на каждый тип по кадрам t и
...
![Рис. 4](../docs/figures/inversion_by_layer.gif)

*Рис. 4. Инверсия модели ноль. Верхний ряд: видео, восстановленное из
...
![Рис. 5](../docs/figures/two_brains.gif)

*Рис. 5. Один клип, два мозга: одинаковая инверсия на коннектоме FlyVis
...
![Рис. 6](../docs/figures/state_to_video.gif)

*Рис. 6. 13B на отложенных клипах. Сверху клип, ниже — видео из его состояния
...
uv run python tools/fig_gh_layers.py       # рис. 2
uv run python tools/fig_gh_decoding.py     # рис. 3
uv run python tools/fig_gh_inversion.py    # рис. 4
uv run python tools/fig_gh_two_brains.py   # рис. 5
uv run python tools/fig_gh_render.py       # рис. 6
```
