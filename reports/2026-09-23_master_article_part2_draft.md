...
генерируемых картинках появилась структура, а сцена пока не доказана. Текущий план и разрешения — только в
[ROADMAP](../ROADMAP.md).
...
структурным судьям: в генерируемых картинках появилась структура. Является ли
она сценой, пока не доказано — для этого не хватает нормального отрисовщика и
метрики «это сцена».
