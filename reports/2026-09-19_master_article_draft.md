...
(0,922 против 0,906 у FlyVis). **Ошибка предпочтительного направления у неё
хуже эталона:** в среднем 39,2° против 31,7°. У члена 000, который используется
дальше как замороженная модель, — 45,8° против 11,5°, и часть его
избирательности T5 направлена не туда. Модель ноль — работающая, но заметно
более слабая детекторная система, чем FlyVis.
