...
*Григорий Воякин, сентябрь 2026.* [English version](2026-09-23_article_part2_en.md). Код, данные о запусках и все иллюстрации —
в репозитории [fly-brain](https://github.com/Grigoriy-V/fly-brain).
[Первая часть](2026-09-19_article_part1_ru.md) кончается на шаге 14: цепочка
...
![Рис. 1](../docs/figures/first_priors.gif)
...
![Рис. 2](../docs/figures/flow_inversion.gif)
...
![Рис. 3](../docs/figures/levers_and_judge.png)
...
![Рис. 4](../docs/figures/seed_shell.gif)
...
- **Цепочка восстанавливает выброшенное.** Половина состояния, обнулённая и
  ...
  недооценивал эффект. [Отчёт](2026-09-21_state_restoration.md).
...
![Рис. 5](../docs/figures/hex_flow.png)
...
![Рис. 6](../docs/figures/seed_known_and_random.gif)
...
![Рис. 7](../docs/figures/bought_kurtosis.png)
...
![Рис. 8](../docs/figures/static_chain.png)
...
![Рис. 9](../docs/figures/static_draws.png)
