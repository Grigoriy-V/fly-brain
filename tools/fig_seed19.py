...
def main(argv=None) -> int:
    ...
    title = (
        ...
        f"состояния, в десять раз хуже. И у этого есть адрес: на {S['draw_many']['n_draws']} розыгрышах поток "
        ...
        f"против {ru(f'{dat['radius_sd']:.2f}')} у данных. Он делает примерно половину переноса, то есть недоучен. "
