...
Постановка 2026-09-20: пока нельзя вбить сид в noise2state руками и получить
видео, как на настоящем клипе, результата нет. Критерий: судить по клипу против **сырого видео
