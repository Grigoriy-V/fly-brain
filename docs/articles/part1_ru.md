...
*Григорий Воякин, сентябрь 2026.* [English version](part1_en.md). Код, данные о запусках и все иллюстрации —
в репозитории [fly-brain](https://github.com/Grigoriy-V/fly-brain). Вторая
часть — [генерация без исходного клипа](part2_ru.md).
...
![Рис. 1](../figures/connectome_export.png)
...
MaleCNS их 51 875. [Отчёт о данных](../../reports/2026-09-18_step1_data.md).
...
![Рис. 2](../figures/dsi_by_version.png)
...
[Отчёт шага 2](../../reports/2026-09-18_step2_model_zero.md) (таблица v7 и v9 по подтипам —
в его § 7), причина первой ошибки — ISS-0003 в [ISSUES](../../ISSUES.md).

## 3. Что можно прочитать обратно из разных уровней

![Рис. 3](../figures/layers_activity.gif)
...
![Рис. 4](../figures/decoder_window.png)
...
![Рис. 5](../figures/decoding_by_type.gif)
...
утверждаем. [Отчёт декодера](../../reports/2026-09-18_step4_decoder_stack.md), ISS-0004 и
ISS-0006.
...
![Рис. 6](../figures/inversion_by_layer.gif)
...
[Отчёт](../../reports/2026-09-19_step9_window_margin.md), код `flydream/generate/invert.py`.
...
его не ограничивает. [Отчёт о вариантах обучения](../../reports/2026-09-18_step3_training_options.md).
...
[Таблица замера](../../reports/2026-09-19_step9_window_margin.md#item-10-the-ladder-batched-same-day).

![Рис. 8](../figures/speedups.png)
...
[Стенд](../../reports/2026-09-18_training_optimization_bench.md).
...
![Рис. 9](../figures/inversion_chart.png)
...
[Отчёт](../../reports/2026-09-19_step11_dreams_lite.md).
...
[Отчёт](../../reports/2026-09-19_step12_manipulated_states.md).
...
[Отчёт 13A](../../reports/2026-09-19_step13a_amortised_inversion.md).
...
![Рис. 10](../figures/state_to_video.gif)
...
[Отчёт 13B](../../reports/2026-09-20_step13b_generative_decoder.md).
...
![Рис. 11](../figures/round_trips.png)
...
![Рис. 12](../figures/closed_loop.png)
...
[Отчёт 14](../../reports/2026-09-20_step14_controllable_generator.md).
